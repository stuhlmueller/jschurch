...
var BgL_loadzf3zf3;
const_church_compiler_tmp = sc_list("\uEBACapply", "\uEBACforce", "\uEBACreset-store-xrp-draws", "\uEBACmake-xrp", "\uEBACmake-initial-mcmc-state", "\uEBACmake-initial-enumeration-state");
...
BgL_sc_const_12z00_church_compiler_tmp = sc_list(new sc_Pair("\uEBACxrp-name", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACxrp-name", null)))), null)), new sc_Pair("\uEBACsample", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsample", null)))), null)), new sc_Pair("\uEBACincr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACincr-stats", null)))), null)), new sc_Pair("\uEBACdecr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACdecr-stats", null)))), null)), new sc_Pair("\uEBACscore", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACscore", null)))), null)), new sc_Pair("\uEBACinit-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACinit-stats", null)))), null)), new sc_Pair("\uEBAChyperparams", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBAChyperparams", null)))), null)), new sc_Pair("\uEBACproposer", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACproposer", null)))), null)), new sc_Pair("\uEBACsupport", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsupport", null)))), null)));
