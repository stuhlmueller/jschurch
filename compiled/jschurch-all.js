...
var BgL_loadzf3zf3;
const_church_compiler_tmp = "null-list?: argument out of domain";
BgL_sc_const_1z00_church_compiler_tmp = "  temps remaining: ";
BgL_sc_const_2z00_church_compiler_tmp = sc_list("\uEBACapply", "\uEBACforce", "\uEBACreset-store-xrp-draws", "\uEBACmake-xrp", "\uEBACmake-initial-mcmc-state", "\uEBACmake-initial-enumeration-state");
...
BgL_sc_const_7z00_church_compiler_tmp = sc_list(new sc_Pair("\uEBACxrp-name", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACxrp-name", null)))), null)), new sc_Pair("\uEBACsample", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsample", null)))), null)), new sc_Pair("\uEBACincr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACincr-stats", null)))), null)), new sc_Pair("\uEBACdecr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACdecr-stats", null)))), null)), new sc_Pair("\uEBACscore", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACscore", null)))), null)), new sc_Pair("\uEBACinit-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACinit-stats", null)))), null)), new sc_Pair("\uEBAChyperparams", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBAChyperparams", null)))), null)), new sc_Pair("\uEBACproposer", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACproposer", null)))), null)), new sc_Pair("\uEBACsupport", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsupport", null)))), null)));
BgL_sc_const_8z00_church_compiler_tmp = "annealing-initializer: failed, restarting at top ...\n";
BgL_sc_const_9z00_church_compiler_tmp = "annealing-initializer: succeeded!\n";
BgL_sc_const_10z00_church_compiler_tmp = "warning: no-proposals not implemented.\n";
BgL_sc_const_11z00_church_compiler_tmp = " not found on Church include paths.";
BgL_sc_const_12z00_church_compiler_tmp = "Negative step count";
BgL_sc_const_13z00_church_compiler_tmp = "ascent loop, temp=";
...
iota = function(count) {
    ...
    if (count < 0) {
      sc_error(BgL_sc_const_12z00_church_compiler_tmp, iota, count);
    }
...
BgL_nullzd2listzf3z21 = function(l) {
    if (l instanceof sc_Pair) {
      ...
      if (l === null) {
        ...
        return sc_error(const_church_compiler_tmp, l);
      }
    }
  };
...
BgL_openzd2includedzd2filez00 = function(filename) {
    ...
    return sc_error(BgL_sc_const_3z00_church_compiler_tmp, "File " + filename + BgL_sc_const_11z00_church_compiler_tmp);
  };
