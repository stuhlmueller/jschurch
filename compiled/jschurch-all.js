...
BgL_sc_const_1z00_church_compiler_tmp = sc_list(new sc_Pair("\uEBACxrp-name", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACxrp-name", null)))), null)), new sc_Pair("\uEBACsample", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsample", null)))), null)), new sc_Pair("\uEBACincr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACincr-stats", null)))), null)), new sc_Pair("\uEBACdecr-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACdecr-stats", null)))), null)), new sc_Pair("\uEBACscore", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACscore", null)))), null)), new sc_Pair("\uEBACinit-stats", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACinit-stats", null)))), null)), new sc_Pair("\uEBAChyperparams", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBAChyperparams", null)))), null)), new sc_Pair("\uEBACproposer", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACproposer", null)))), null)), new sc_Pair("\uEBACsupport", new sc_Pair(new sc_Pair("\uEBACchurch-force", new sc_Pair("\uEBACaddress", new sc_Pair("\uEBACstore", new sc_Pair("\uEBACsupport", null)))), null)));
...
BgL_sc_const_13z00_church_compiler_tmp = "This shouldn't happen";
BgL_sc_const_14z00_church_compiler_tmp = "Too many arguments to MAKE-LIST";
BgL_sc_const_15z00_church_compiler_tmp = sc_list("\uEBACapply", "\uEBACforce", "\uEBACreset-store-xrp-draws", "\uEBACmake-xrp", "\uEBACmake-initial-mcmc-state", "\uEBACmake-initial-enumeration-state");
...
BgL_makezd2listzd2 = function(len) {
    ...
    if (maybe_elt === null) {
      ...
      if (maybe_elt.cdr === null) {
        ...
        elt = sc_error(BgL_sc_const_14z00_church_compiler_tmp, new sc_Pair(len, maybe_elt));
      }
    }
    ans_2 = null;
    i = len;
    ...
    if (parameters instanceof sc_Pair) {
      ...
      if (parameters === null) {
        ...
        if (sc_isSymbol(parameters)) {
          ...
          return sc_error(parameters, BgL_sc_const_13z00_church_compiler_tmp);
        }
      }
    }
  };
